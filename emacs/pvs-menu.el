...
(defconst pvs-mode-menus
  '("PVS"
    ...
    ("Prover Invocation"
     ...
     ["prove-theory" prove-theory t]
     ["prove-theories" prove-theories t]
     ["prove-pvs-file" prove-pvs-file t]
     ["prove-importchain" prove-importchain t]
     ...
     ["prove-untried-importchain" prove-untried-importchain t]
     ["prove-untried-importchain-subtree" prove-untried-importchain-subtree t]
     ["prove-untried-pvs-file" prove-untried-pvs-file t]
     ["prove-untried-theory" prove-untried-theory t]
     ["prove-formulas-importchain" prove-formulas-importchain t]
     ["prove-formulas-importchain-subtree" prove-formulas-importchain-subtree t]
     ["prove-formulas-pvs-file" prove-formulas-pvs-file t]
     ["prove-formulas-theory" prove-formulas-theory t]
     ;; Reprove TCCs
     ["reprove-tccs-importchain" reprove-tccs-importchain t]
     ;; ["reprove-tccs-importchain-subtree" reprove-tccs-importchain-subtree t]
     ["reprove-tccs-pvs-file" reprove-tccs-pvs-file t]
     ["reprove-tccs-theory" reprove-tccs-theory t]
     ;; Prove TCCs with a strategy
