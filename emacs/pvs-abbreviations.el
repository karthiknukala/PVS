...
(global-set-key "\C-c\C-hu" 'help-pvs-unicode)
...
(pvs-abbreviate 'change-workspace 'cc)
(pvs-abbreviate 'change-workspace 'change-context)
(pvs-abbreviate 'change-workspace 'cw)
...
(pvs-abbreviate 'help-pvs-unicode 'pvs-help-unicode)
