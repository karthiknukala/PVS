# Yices2 API Translation for Predicate Subtypes and Dependent Types

This note describes how the Yices2 CFFI prover in `api-prover.lisp` now
encodes predicate subtypes and dependent types.
...
- unsupported surface forms such as `cases`, strings, and bitvector operators
  remain unsupported in `api-prover.lisp`
